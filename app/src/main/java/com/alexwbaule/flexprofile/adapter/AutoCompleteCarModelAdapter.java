...
public class AutoCompleteCarModelAdapter extends CursorAdapter {
    private MeuCarroApplication rootapp = MeuCarroApplication.getInstance();
    Context context;


    public AutoCompleteCarModelAdapter(Context context) {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        currentCursor = rootapp.getCarModel(args);
